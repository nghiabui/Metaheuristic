...
/**
 * @author VuHT
 * Description: LPT_HEU1 scheduling algorithm (get the largest job)
 */
public class LPTFirstJobHeuristic {
	// Start time
	...
	// Constructor
	public LPTFirstJobHeuristic() {
		
	}
	
	// First job LPT heuristic scheduling
	public static void schedule(Instance ins) {
		...
		while(!ins.listAperiodicJob.isEmpty()) {
			...
			else { // LPT_HEU1: First job that is smaller than Tmax
